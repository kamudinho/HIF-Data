...
PLAYER_MAPPING = [
    ...
    # Hobro
    {"klub": "#Hobro IK", "navn": "Oscar Nørgaard Meedom", "position": "Attacker", "player_optauuid": "4dmz3u7j1eoz4ofr1o8tbxedw", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Théo Puggaard Ekié Hansen", "position": "Midfielder", "player_optauuid": "e0rgqk3gxzs005m9ok9hvp1ck", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Mikkel Mejlstrup Pedersen", "position": "Midfielder", "player_optauuid": "9xub4z9b3bog8wqhn5yfihecp", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Søren Skals Andreasen", "position": "Attacker", "player_optauuid": "4qyfoq5fjiochtj89w426lm21", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Oliver Augustus Sparre Klitten", "position": "Attacker", "player_optauuid": "e19g5bz7s9wqcvj8mttztxi0a", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Jonas Dakir", "position": "Goalkeeper", "player_optauuid": "9yxhg70gpwi3e9s84c8qwg0yx", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Marius Haudrum Jacobsen", "position": "Defender", "player_optauuid": "6bv0j0ezhh9u5u5hqz64p790q", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Mikkel Bach Løndal", "position": "Defender", "player_optauuid": "ehjqrbqo7ewbztia7k2mrzx90", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Frederik Dietz Nielsen", "position": "Defender", "player_optauuid": "ebd3uvtt54wkdsahc2127j02c", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Anders Abdull-Gaffar Haidar Noshe", "position": "Defender", "player_optauuid": "3c7oy1stwyquawdfzzom13xn8", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Oliver Friis Dorph", "position": "Defender", "player_optauuid": "ayhdul772mr22qoly04psb3f8", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Lukas Sparre Klitten", "position": "Defender", "player_optauuid": "a2x4o6ufsqoz2zz7tqcnvo16", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Mikkel Kannegaard Kristensen", "position": "Defender", "player_optauuid": "3sog1gsk11bwwrf7l7wm2j7dg", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Christian Enemark", "position": "Defender", "player_optauuid": "2qedb8t85t1ieeed9613c9crt", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    {"klub": "#Hobro IK", "navn": "Martin Staghøj Huldahl", "position": "Attacker", "player_optauuid": "876cmwkx9p9wsqgdddfzmipzo", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},

    # Hvidovre IF
    "471964": {"klub": "#Hvidovre IF", "navn": "Filip Đukić", "position": "Goalkeeper", "pos": "1", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "d9hh01mit4geyadol3gmzco9", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "483429": {"klub": "#Hvidovre IF", "navn": "Ahmed Iljazovski", "position": "Defender", "pos": "5", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "bfvdr7ckiersz26ya2kq9f1g4", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "764636": {"klub": "#Hvidovre IF", "navn": "Alexander Johansen", "position": "Attacker", "pos": "11", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "7ymn0ytcqi6l43nqraxt9s1zo", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "562692": {"klub": "#Hvidovre IF", "navn": "Andreas Smed", "position": "Midfielder", "pos": "7", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "dncrhma6gwcn6pxiu7hfc6qz8", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "224185": {"klub": "#Hvidovre IF", "navn": "Ayo Simon Okosun", "position": "Midfielder", "pos": "8", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "7eramyy1bd8msxmg84ctc8ut", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "56017": {"klub": "#Hvidovre IF", "navn": "Daniel Stenderup", "position": "Defender", "pos": "3", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "a30gduuv9d1s4pkthgu2jhyol", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "607033": {"klub": "#Hvidovre IF", "navn": "Donavan Bagou", "position": "Attacker", "pos": "10", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "1hlx5mvl8th7y82gocnuxacd0", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "748624": {"klub": "#Hvidovre IF", "navn": "Emmanuel Aby", "position": "Attacker", "pos": "10", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "907vtkod58b7986k7u1619gr8", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "462085": {"klub": "#Hvidovre IF", "navn": "Frederik Rask Høgh Jensen", "position": "Attacker", "pos": "9", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "9tt9eo9bsff7dp7aqjal1obo4", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "562503": {"klub": "#Hvidovre IF", "navn": "Louka Prip", "position": "Attacker", "pos": "11", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "9dnceiwcpsatrdrj2m1uz6pnu", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "370269": {"klub": "#Hvidovre IF", "navn": "Malte Kiilerich Hansen", "position": "Defender", "pos": "3", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "630daj1ef34rczbhng0eoncvd", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "505392": {"klub": "#Hvidovre IF", "navn": "Marius Elvius", "position": "Defender", "pos": "4", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "6c2isptqoy4cq5c8rlr9s1roq", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "417657": {"klub": "#Hvidovre IF", "navn": "Nicolai Clausen", "position": "Defender", "pos": "4", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "6dzg820946z4848whaa6ny2nd", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "579393": {"klub": "#Hvidovre IF", "navn": "Nicolaj Jungvig", "position": "Defender", "pos": "3", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "3pk6hii2s8tbv2zux8mvbapec", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "525614": {"klub": "#Hvidovre IF", "navn": "Oliver Bjerrum Jensen", "position": "Midfielder", "pos": "8", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "4e7sicg0km2z5jq80ptgaxo4q", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "519715": {"klub": "#Hvidovre IF", "navn": "Oliver Juul", "position": "Defender", "pos": "4", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "aejgqvdw1jftxaa538kaa15w4", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "435879": {"klub": "#Hvidovre IF", "navn": "Oliver Kjærgaard", "position": "Midfielder", "pos": "6", "pos_prioritet": "A - Start-11", "kontrakt": "2027-06-30", "player_optauuid": "cl4xl80n4gew1ox03r3ooshrd", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    "620821": {"klub": "#Hvidovre IF", "navn": "Zamir Aliji", "position": "Midfielder", "pos": "8", "pos_prioritet": "B - Trupspiller", "kontrakt": "2027-06-30", "player_optauuid": "aajgld24isoem1ycoysyxxp1w", "competition_optauuid": "6ifaeunfdelecgticvxanikzu"},
    # Kolding
