...
def get_opta_queries(liga_f, saeson_f, hif_only=False):
    ...
    # Disse UUID'er er nøglen til at fjerne fejlene:
    ...
    return {
        # 1. MATCHINFO bruger ofte navne, men lad os bruge UUID for at være sikre
        ...
        # 2. Rettet: Skiftet til _OPTAUUID
        ...
        # 3. Rettet: Bruger QUALIFIER_QID (som vi så i din dump) og TOURNAMENTCALENDAR_OPTAUUID
        "opta_shotevents": f"""
