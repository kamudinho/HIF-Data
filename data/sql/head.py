    ...
    query = f"""
        ...
        MatchBase AS (
            SELECT MATCH_OPTAUUID, MATCH_DATE_FULL, WEEK, MATCH_STATUS, 
                   ...
                   TOTAL_HOME_SCORE, TOTAL_AWAY_SCORE, VENUE_LONGNAME, MATCH_LOCALTIME, MATCH_TIME
