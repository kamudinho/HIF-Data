...
def prepare_df(content, is_hif=False):
    ...
    # Konverter datoer (vigtigt for at undgå String/Date fejl)
    df['Kontrakt'] = pd.to_datetime(df['Kontrakt'], dayfirst=True, errors='coerce').dt.date
    
    # Sikr at de tre formations-kolonner eksisterer
...
def vis_side(dp=None):
    ...
    s_e = df_emner[df_emner['Skyggehold']]
    s_h = df_hif[df_hif['Skyggehold']]
