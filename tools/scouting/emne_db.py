...
def vis_side():
    ...
    with t4:
        ...
        with c_pitch:
            ...
            ax.text(23, 3, " Transfer (Fri) ", size=6, weight='bold', bbox=dict(facecolor=GRON_NY))
            ax.text(34, 3, " Transferkøb ", size=6, weight='bold', color='white', bbox=dict(facecolor=HIF_BLA))
