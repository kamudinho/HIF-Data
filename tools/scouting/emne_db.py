...
def vis_side():
    ...
    with t4:
        ...
        with c_pitch:
            ...
            ax.text(1, 3, " < 6 mdr ", size=6, weight='bold', bbox=dict(facecolor=ROD_ADVARSEL))
            ax.text(8, 3, " 6-12 mdr ", size=6, weight='bold', bbox=dict(facecolor=GUL_ADVARSEL))
            ax.text(16, 3, " Transfer (Fri) ", size=6, weight='bold', bbox=dict(facecolor=GRON_NY))
            ax.text(26, 3, " Transferkøb ", size=6, weight='bold', color='white', bbox=dict(facecolor=HIF_BLA))
