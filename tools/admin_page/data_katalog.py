...
def vis_side(conn):
    ...
    # --- FANE 1: TABELSTRUKTUR (SAMLET AXIS-VIEW) ---
    with tab_struktur:
        # Hent ALLE tabeller i AXIS
        query_tabeller = f"""
            SELECT TABLE_NAME 
        ...
        # Dropdown med alle tabeller
        valgt_tabel = st.selectbox("Vælg tabel i AXIS:", df_tabeller['TABLE_NAME'].tolist())
        ...
        if valgt_tabel:
            ...
            st.write(f"### Kolonner i AXIS.{valgt_tabel}")
