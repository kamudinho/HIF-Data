...
def render_setpiece_analysis(df_team, sp_type, t_sel):
    ...
    with col_p:
        ...
        if hold_logo:
            ...
            ax_logo.axis('off')
            ax.text(6.2, 63.2, t_sel.upper(), fontsize=4, fontweight='bold', color='#222222', alpha=0.9, va='center')
        else:
            ax.text(2.0, 63.2, t_sel.upper(), fontsize=4, fontweight='bold', color='#222222', alpha=0.9, va='center')
