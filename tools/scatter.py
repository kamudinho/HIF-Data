...
def build_scatter_plot(df_plot, x_label, y_label): # Modtager nu labels direkte
    ...
    # --- HOVER-BOKS: Kun Holdnavn, X og Y ---
    fig.update_traces(
...
def vis_side(df_scatter):
    ...
    if not df_filtered.empty:
        # Hent data fra vores nye 4-trins format
        ...
        # Send de rene labels med til plottet
