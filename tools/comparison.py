...
def vis_side(spillere, player_events, df_scout):
    ...
    radar_defs = {
        ...
        'Spilintelligens': 'Forståelse for positionering og evne til at læse spillets mønstre.'
    }
    ...
    def hent_spiller_data(navn):
        try:
            ...
            return {}, {}, {k: 0 for k in ['TEKNIK', 'BESLUTSOMHED', 'FART', 'AGGRESIVITET', 'ATTITUDE', 'UDHOLDENHED', 'LEDEREGENSKABER', 'SPILINTELLIGENS']}
        ...
        tech_stats = {'TEKNIK': 0, 'BESLUTSOMHED': 0, 'FART': 0, 'AGGRESIVITET': 0, 'ATTITUDE': 0, 'UDHOLDENHED': 0, 'LEDEREGENSKABER': 0, 'SPILINTELLIGENS': 0}
    ...
    # Nøglerne her skal matche tech_stats ordbogen
    ...
    with c2:
        # Spørgsmålstegn øverst til højre for radaren
