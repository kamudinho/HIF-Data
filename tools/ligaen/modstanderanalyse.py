...
def vis_side(dp=None):
    ...
    with t1:
        ...
        with main_col2:
            ...
            fig1.update_layout(height=250, margin=dict(t=15, b=0, l=0, r=0), plot_bgcolor='rgba(0,0,0,0)', xaxis_title=None, yaxis_title=None)
            ...
            fig2.update_layout(height=250, margin=dict(t=15, b=0, l=0, r=0), plot_bgcolor='rgba(0,0,0,0)', xaxis_title=None, yaxis_title=None)
