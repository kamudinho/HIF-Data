...
def vis_side():
    ...
    with t_h2h:
        ...
        if len(alle_hold) >= 2:
            ...
            with tabs[4]: draw_h2h_chart(t1, t2, ['PASSES', 'CROSSESTOTAL', 'PROGRESSIVEPASSES', 'PASSTOFINALTHIRDS'], ['Afleveringer', 'Indlæg', 'Til sidste 20m før mål', 'Sidste 1/3'], df_wy, "pass")
