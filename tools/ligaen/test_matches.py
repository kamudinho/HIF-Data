    ...
    sql = f"""
        ...
        AdvancedEvents AS (
            SELECT 
                ...
                -- Opta boks-koordinater er typisk X > 83.3 og Y mellem 21.1 og 78.9
                COUNT(CASE WHEN EVENT_TYPEID = 1 AND EVENT_X > 83.3 AND EVENT_Y BETWEEN 21.1 AND 78.9 THEN 1 END) AS TOUCHES_IN_BOX,
        ...
        for _, row in played_p.sort_values('MATCH_DATE_FULL', ascending=False).iterrows():
            ...
            with st.container(border=True):
                ...
                stats_conf = [
                    ...
                    ("HOME_TOUCHES", "AWAY_TOUCHES", "TOUCHES", "Touches i boks", 0, ""), # <--- HER SKAL KOMMAET VÆRE
