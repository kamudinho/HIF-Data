    ...
    try:
        ...
        if valgt_hold != "Alle hold":
            ...
            for _, r in f_df.iterrows():
                ...
                # Stats logik
                cur_mf = h if is_home else a
                cur_mm = a if is_home else h
                mf += cur_mf
                mm += cur_mm
            ...
            f_df = df.copy()
            stats_html = f"<div style='padding-top:8px;'><span style='font-size:14px; color:#555;'>Viser alle {len(f_df)} kampe</span></div>"
