...
def vis_side():
    ...
    # 3. DATA MERGE LOGIK (Her kobler vi OPTA_TEAM_STATS på kampene)
    ...
    # 5. TEGN KAMPE FUNKTION (Inkluderet logoer og small stats)
