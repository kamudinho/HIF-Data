...
def vis_side(dp):
    """
    Stabil version af kampsiden. 
    Bruger MATCH_DATE_FULL for maksimal kompatibilitet.
    """
    # 1. HENT DATA
    ...
    st.markdown("""
        ...
        .score-pill { background: #333; color: white; border-radius: 4px; padding: 2px 10px; font-weight: bold; min-width: 60px; display: inline-block; text-align: center; }
        </style>
    ...
    def tegn_kampe(df, played):
        ...
        for _, row in df.iterrows():
            # Vi bruger MATCH_DATE_FULL da den er mest stabil til sortering og visning
            ...
            with st.container(border=True):
                ...
                with c3:
                    if played:
                        ...
                        # Tidspunktet bliver 00:00 i oversigten hvis det ikke findes i MATCH_DATE_FULL
