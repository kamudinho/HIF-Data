...
def vis_side(df_events, df_spillere, hold_map):
    ...
    # Filtrer til HIF skud (PRIMARYTYPE og TEAM_WYID fra din debug)
    ...
    # Sorter kronologisk og generer løbenummer (ID)
    ...
    # --- 4. TEGN BANE ---
    # Wyscout pitch system: VerticalPitch zoomer ind på modstanderens banehalvdel
