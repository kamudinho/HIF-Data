...
import os
import pandas as pd
from tools import heatmaps, shots, skudmap, dataviz, players, comparison, stats, goalzone, top5, squad, player_goalzone
...
st.markdown("""
    <style>
        .block-container { padding-top: 0rem !important; margin-top: -25px !important; }
        [data-testid="stHeader"] { display: none !important; }
        [data-testid="stSidebarNav"] { display: none; }
        [data-testid="stSidebarUserContent"] { padding-top: 0.5rem !important; margin-top: -50px !important; }
        .sidebar-top-container { display: flex; align-items: center; justify-content: center; position: relative; margin-bottom: 10px; }
        .logout-link { color: #d3d3d3 !important; font-size: 22px !important; position: absolute; left: 5px; }
        .logout-link:hover { color: #cc0000 !important; }
        .sidebar-logo { width: 70px; }
        div.row-widget.stRadio > div { background-color: #f8f9fb; padding: 10px; border-radius: 10px; border: 1px solid #eceef1; }
...
# --- 4. SIDEBAR ---
with st.sidebar:
    st.markdown(f'<div class="sidebar-top-container"><a href="/?logout=true" target="_self" class="logout-link"><i class="bi bi-box-arrow-left"></i></a><img src="https://cdn5.wyscout.com/photos/team/public/2659_120x120.png" class="sidebar-logo"></div>', unsafe_allow_html=True)
