...
st.markdown("""
    <style>
        ...
        /* SKJUL STREAMLITS STANDARD HEADER */
        [data-testid="stHeader"] {
            display: none !important;
        }
        
        /* SIDEBAR NAVIGATION & TOP GAB */
...
with st.sidebar:
    ...
    # Hovedmenu - Vigtigt: Navnet "DATA - SPILLERE" skal matche routing længere nede
